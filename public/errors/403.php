...
<head>
	...
	<title>Akses terlarang - <?php echo identitas("judul");?></title>
				...
				<div class="content d-flex justify-content-center align-items-center">
					...
					<div class="flex-fill">
						...
						<div class="text-center mb-4">
							...
							<h6 class="w-md-25 mx-md-auto">Oops, terjadi kesalahan.<br>Akses terhadap halaman ini tidak diperbolehkan.</h6>
						</div>
						<!-- /error title -->
