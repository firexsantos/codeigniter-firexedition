					...
					<div class="page-header-content d-lg-flex">
						...
						<div class="collapse d-lg-block my-lg-auto ms-lg-auto" id="page_header">
							<div class="hstack gap-3 mb-3 mb-lg-0">
                                <a href="<?= base_url("users/pokja/add") ?>" class="btn btn-outline-primary btn-labeled btn-labeled-start rounded-pill">
						...
						<div class="">
                            <table class="table table-hover datatable-highlight">
								...
								<tbody>
									<?php
                                        $nodata = 1;
                                        $sdata = $this->db->query("SELECT a.*, b.`nm_jk`, c.`nm_agama`, d.`nm_group` FROM users a LEFT JOIN jk b ON a.`id_jk` = b.`id_jk` LEFT JOIN agama c ON a.`id_agama` = c.`id_agama` LEFT JOIN `group` d ON a.`id_group` = d.`id_group` WHERE a.id_group LIKE '5'");
                                                        ...
                                                        <div class='d-inline-flex'>
                                                            <div class='dropdown'>
                                                                ...
                                                                <div class='dropdown-menu dropdown-menu-end'>
                                                                    <a href='".base_url("users/pokja/edit/".enkrip($ddata['no_register']))."' class='dropdown-item'>
