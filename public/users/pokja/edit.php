					...
					<div class="page-header-content d-lg-flex border-top">
						<div class="d-flex">
							<div class="breadcrumb py-2">
								...
								<a href="<?= base_url("users/pokja") ?>" class="breadcrumb-item">Data POKJA Pemilihan</a>
                        ...
                        <div class="col-md-8 col-lg-6">
                            <form method="post" class="card">
                                        ...
                                        <span class="multiselect-native-select">
                                            <select class="form-control multiselect" multiple="multiple" data-include-select-all-option="true" name="groupe[]" required>
                                                <?php
                                                    ...
                                                    $sgr = $this->db->query("SELECT * FROM `group` WHERE id_group = '5'");
                                ...
                                <div class="card-footer">
                                    <a href="<?= base_url("users/pokja") ?>" class="btn btn-link">Batal</a>
